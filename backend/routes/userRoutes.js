...
import { loginController, signupController, googleLoginController, getNurses, getCurrentUser, deleteNurses, updateNurse } from "../controllers/userController.js";
const nurseRouter = express.Router();

nurseRouter.post("/login", loginController);
nurseRouter.post("/signup", signupController);
nurseRouter.post("/google-login", googleLoginController);
